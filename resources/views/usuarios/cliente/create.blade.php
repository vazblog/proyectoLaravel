                ...
                <div class="col-xl-6 col-lg-7 col-md-8 mx-auto">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="font-weight-bolder mt-1">Crear Nuevo Cliente</h4>
                            <p class="mb-1 text-sm">Por favor, ingresa la información solicitada para crear un nuevo
                                cliente.
                            </p>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="{{ route('usuarios.clientes.store') }}"
                                ...
                                <div class="input-group input-group-static mb-4">
                                    ...
                                    <input id="apellido_dos" type="text"
                                        class="form-control  @error('apellido_dos') is-invalid @enderror"
                                        name="apellido_dos" value="{{ old('apellido_dos') }}" required
                                ...
                                <div class="input-group input-group-static mb-4">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="suscripcion"
                                            id="suscripcion_si" value="S"
                                            {{ old('suscripcion') == 'S' ? 'checked' : '' }}>
                                        <label class="form-check-label" for="suscripcion_si">{{ __('Sí') }}</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="suscripcion"
                                            id="suscripcion_no" value="N"
                                            {{ old('suscripcion') == 'N' ? 'checked' : '' }}>
